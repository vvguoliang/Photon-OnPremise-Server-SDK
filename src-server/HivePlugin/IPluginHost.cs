...
namespace Photon.Hive.Plugin
{
    ...
    public class CacheOperations
    {
        ...
        /// <summary>
        /// Removes events from cache. Filters like event code, actors list and daata in Hashtable form can be applied
        /// </summary>
    ...
    public class SerializableGameState
    {
        ...
        /// <summary>
        /// contains flags regulating differnt aspects of rooms behaviour
        /// </summary>
