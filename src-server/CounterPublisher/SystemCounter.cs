...
namespace Photon.CounterPublisher
{
    ...
    public class SystemCounter
    {
        ...
        [PublishCounter(Name = "PacketsReceivedPerSecond")]
        public static readonly NetworkInterfaceCounter PackagesReceivedPerSecond = new NetworkInterfaceCounter("PacketsReceivedPerSecond", "Packets Received/sec");
