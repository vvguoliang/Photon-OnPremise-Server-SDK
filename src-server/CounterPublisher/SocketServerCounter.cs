...
namespace Photon.CounterPublisher
{
    ...
    {        
        ...
        /// <summary>
        ///  The total number of peers (TCP + UDP) increased per second.
        /// </summary>
        [PublishCounter("PeersPerSecond")]
        public static readonly PerformanceCounterReader PeersPerSecondCounter =
            CreateCounterReader(Schema.Common.CategoryName, Schema.Common.TotalPeersCounterPlusPerSecond);
        ...
        /// <summary>
        /// The WebSockets peers counter.
        /// </summary>
        [PublishCounter("WebSocketsPeers")]
        public static readonly PerformanceCounterReader WebSocketsPeersCounter =
            CreateCounterReader(Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersCounter);

        [PublishCounter("WebSocketsDisconnectedPeersPerSecond")]
        public static readonly PerformanceCounterReader WebSocketsDisconnectedPeersPerSecond = CreateCounterReader(
            Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersDisconnectedCounterPlusPerSecond);

        [PublishCounter("WebSocketsDisconnectedPeersByClientPerSecond")]
        public static readonly PerformanceCounterReader WebSocketsDisconnectedPeersByClientPerSecond = CreateCounterReader(
            Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersDisconnectedByClientCounterPlusPerSecond);

        [PublishCounter("WebSocketsDisconnectedPeersByManagedPerSecond")]
        public static readonly PerformanceCounterReader WebSocketsDisconnectedPeersByManagedPerSecond = CreateCounterReader(
            Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersDisconnectedByAppCounterPlusPerSecond);

        [PublishCounter("WebSocketsDisconnectedPeersByServerPerSecond")]
        public static readonly PerformanceCounterReader WebSocketsDisconnectedPeersByServerPerSecond = CreateCounterReader(
            Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersDisconnectedByServerCounterPlusPerSecond);

        [PublishCounter("WebSocketsDisconnectedPeersByTimeoutPerSecond")]
        public static readonly PerformanceCounterReader WebSocketsDisconnectedPeersByTimeoutPerSecond = CreateCounterReader(
            Schema.WebSockets.CategoryName, Schema.WebSockets.WebSocketsPeersDisconnectedByTimeoutCounterPlusPerSecond);
