...
namespace Photon.CounterPublisher
{
    public static class SocketServerCounterSchema
    {
        ...
        //this is a copy from Tcp, only the used values were checked if the counters actually exist (if names are correct)
        public static class WebSockets
        {
            #region Constants and Fields

            public static readonly string CategoryName = "Photon Socket Server: WebSockets";

            public static readonly string WebSocketFlowControl25Counter = "WebSocket: Flow Control 25%";

            public static readonly string WebSocketFlowControl50Counter = "WebSocket: Flow Control 50%";

            public static readonly string WebSocketFlowControl75Counter = "WebSocket: Flow Control 75%";

            public static readonly string WebSocketFlowControlActiveCounter = "WebSocket: Flow Control Active";

            public static readonly string WebSocketFlowControlBufferFullCounter = "WebSocket: Flow Control Buffer Full Events";

            public static readonly string WebSocketFlowControlBufferQueueCounter = "WebSocket: Flow Control Buffer Queue";

            public static readonly string WebSocketFlowControlBufferQueueMinusPerSecondCounter = "WebSocket: Flow Control Buffer Queue -/sec";

            public static readonly string WebSocketFlowControlBufferQueuePlusPerSecondCounter = "WebSocket: Flow Control Buffer Queue +/sec";

            public static readonly string WebSocketsPeersCounterAllTime = "WebSockets: Peers (all time)";

            public static readonly string WebSocketsPeersCounterMinusPerSecond = "WebSockets: Peers -/sec";

            public static readonly string WebSocketsPeersCounterPlusPerSecond = "WebSockets: Peers +/sec";

            public static readonly string WebSocketsPeersDisconnectedByAppCounter = "WebSockets: Disconnected Peers (M)";

            public static readonly string WebSocketsPeersDisconnectedByAppCounterAllTime = "WebSockets: Disconnected Peers (M) (all time)";

            public static readonly string WebSocketsPeersDisconnectedByAppCounterMinusPerSecond = "WebSockets: Disconnected Peers (M) -/sec";

            public static readonly string WebSocketsPeersDisconnectedByAppCounterPlusPerSecond = "WebSockets: Disconnected Peers (M) +/sec";

            public static readonly string WebSocketsPeersDisconnectedByClientCounter = "WebSockets: Disconnected Peers (C)";

            public static readonly string WebSocketsPeersDisconnectedByClientCounterAllTime = "WebSockets: Disconnected Peers (C) (all time)";

            public static readonly string WebSocketsPeersDisconnectedByClientCounterMinusPerSecond = "WebSockets: Disconnected Peers (C) -/sec";

            public static readonly string WebSocketsPeersDisconnectedByClientCounterPlusPerSecond = "WebSockets: Disconnected Peers (C) +/sec";

            public static readonly string WebSocketsPeersDisconnectedByServerCounter = "WebSockets: Disconnected Peers (S)";

            public static readonly string WebSocketsPeersDisconnectedByServerCounterAllTime = "WebSockets: Disconnected Peers (S) (all time)";

            public static readonly string WebSocketsPeersDisconnectedByServerCounterMinusPerSecond = "WebSockets: Disconnected Peers (S) -/sec";

            public static readonly string WebSocketsPeersDisconnectedByServerCounterPlusPerSecond = "WebSockets: Disconnected Peers (S) +/sec";

            public static readonly string WebSocketsPeersDisconnectedByTimeoutCounter = "WebSockets: Disconnected Peers (T)";

            public static readonly string WebSocketsPeersDisconnectedByTimeoutCounterAllTime = "WebSockets: Disconnected Peers (T) (all time)";

            public static readonly string WebSocketsPeersDisconnectedByTimeoutCounterMinusPerSecond = "WebSockets: Disconnected Peers (T) -/sec";

            public static readonly string WebSocketsPeersDisconnectedByTimeoutCounterPlusPerSecond = "WebSockets: Disconnected Peers (T) +/sec";

            public static readonly string WebSocketsPeersDisconnectedByConnectTimeoutCounter = "WebSockets: Disconnected Peers (CT)";

            public static readonly string WebSocketsPeersDisconnectedByConnectTimeoutCounterAllTime = "WebSockets: Disconnected Peers (CT) (all time)";

            public static readonly string WebSocketsPeersDisconnectedByConnectTimeoutCounterMinusPerSecond = "WebSockets: Disconnected Peers (CT) -/sec";

            public static readonly string WebSocketsPeersDisconnectedByConnectTimeoutCounterPlusPerSecond = "WebSockets: Disconnected Peers (CT) +/sec";

            public static readonly string WebSocketsPeersDisconnectedCounter = "WebSockets: Disconnected Peers";

            public static readonly string WebSocketsPeersDisconnectedCounterAllTime = "WebSockets: Disconnected Peers (all time)";

            public static readonly string WebSocketsPeersDisconnectedCounterMinusPerSecond = "WebSockets: Disconnected Peers -/sec";

            public static readonly string WebSocketsPeersDisconnectedCounterPlusPerSecond = "WebSockets: Disconnected Peers +/sec";

            public static readonly string WebSocketsBytesInCounter = "WebSockets: Bytes in";

            public static readonly string WebSocketsBytesInPerSecondCounter = "WebSockets: Bytes in/sec";

            public static readonly string WebSocketsBytesOutCounter = "WebSockets: Bytes out";

            public static readonly string WebSocketsBytesOutPerSecondCounter = "WebSockets: Bytes out/sec";

            public static readonly string WebSocketsConnectionsActiveCounter = "WebSockets: Connections Active";

            public static readonly string WebSocketsMessagesInCounter = "WebSockets: Messages in";

            public static readonly string WebSocketsMessagesInCounterPerSecond = "WebSockets: Messages in/sec";

            public static readonly string WebSocketsMessagesOutCounter = "WebSockets: Messages out";

            public static readonly string WebSocketsMessagesOutCounterPerSecond = "WebSockets: Messages out/sec";

            public static readonly string WebSocketsPeersCounter = "WebSockets: Peers";
