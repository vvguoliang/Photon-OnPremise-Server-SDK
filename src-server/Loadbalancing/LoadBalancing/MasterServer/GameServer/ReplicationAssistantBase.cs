...
namespace Photon.LoadBalancing.MasterServer.GameServer
{
    public abstract class ReplicationAssistantBase
    {
        ...
        public void ForceFinishReplication()
        {
            ...
            log.Warn($"Replication forcibly finsihed for server.: got replicas: {this.countOfUpdates}, expected replicas: {this.countOfExpectedUpdates} ctx:{this.gameServerContext}");
        }
        #endregion
