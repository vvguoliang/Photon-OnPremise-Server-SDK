...
namespace Photon.LoadBalancing.MasterServer.Lobby
{
    ...
    public abstract class GameListBase : IGameList
    {
        ...
        private class Subscribtion : GameSubscriptionBase
        {
            private readonly GameListBase gameList;

            public Subscribtion(GameListBase gameList, int maxGameCount, MasterClientPeer peer): base(peer, maxGameCount)
            {
