...
namespace Photon.LoadBalancing.MasterServer.Lobby
{
    ...
    public class GameState
    {
        ...
        private readonly List<DeferredUser> waitList = new List<DeferredUser>();
        ...
        /// </summary>
        public GameServerContext GameServer
        {
            get
            {
                return this.gameServerContext;
            }
        }
        ...
        public List<DeferredUser> WaitList { get { return this.waitList; } }
        ...
        public void OnRemoved()
        {
            if (log.IsDebugEnabled)
            {
                log.DebugFormat("Game removed on GS. GameId={0}, ServerId={1}", this.Id, this.gameServerContext);
            }
        ...
        {
            var peer = this.gameServerContext != null ? this.gameServerContext.Peer : null;
            return
                string.Format(
