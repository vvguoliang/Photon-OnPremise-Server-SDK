...
namespace Photon.LoadBalancing.UnitTests.UnifiedTests
{
    public abstract partial class LBApiTestsImpl : LoadBalancingUnifiedTestsBase
    {
        ...
        public void TestTearDown()
        {
            ...
            Assert.That(policy.MasterServer.Application.PeerCount, Is.GreaterThanOrEqualTo(0));
            Assert.That(policy.GameServer.Application.PeerCount, Is.GreaterThanOrEqualTo(0));
            Assert.That(policy.GameServer2.Application.PeerCount, Is.GreaterThanOrEqualTo(0));
        }
        ...
        public void Auth_AuthResponseTest()
        {
            ...
            try
            {
                ...
                Assert.IsNotNull(response.Parameters[ParameterCode.Secret]);
                client.Disconnect();
...
//                Assert.IsNotNull(response.Parameters[ParameterCode.Secret]);
                ...
                var encryptedToken1 = (string)response.Parameters[ParameterCode.Secret];

                this.ConnectToServer(client, this.MasterAddress);
                var parameters = new Dictionary<byte, object>
                {
                    {ParameterCode.Secret, encryptedToken1},
                };
                ...
                var encryptedToken2 = (string)response2.Parameters[ParameterCode.Secret];

                Assert.AreNotEqual(encryptedToken1, encryptedToken2);
                client.Disconnect();

                var tokenFactory = this.CreateAuthTokenFactory();

                var hmacKey = Photon.Common.Authentication.Settings.Default.HMACTokenKey;

                tokenFactory.Initialize(Photon.Common.Authentication.Settings.Default.AuthTokenKey, hmacKey,
                    TimeSpan.FromSeconds(Photon.Common.Authentication.Settings.Default.AuthTokenExpirationS), Environment.MachineName);

                AuthenticationToken decryptedToken1, decryptedToken2;
                string errorMsg;
                tokenFactory.DecryptAuthenticationToken(encryptedToken1, out decryptedToken1, out errorMsg);
                tokenFactory.DecryptAuthenticationToken(encryptedToken2, out decryptedToken2, out errorMsg);
        ...
        protected void Auth_JoinGameTestBody(EncryptionMode encryptionMode)
        {
            ...
            try
            {
                ...
                this.ConnectAndAuthenticate(masterClient1, ap);
                this.ConnectAndAuthenticate(masterClient2, ap);
        ...
        public void MaxPlayers_SetToValueLessThenCurrentAmount([Values(0, 5)]byte initialValue)
        {
            ...
            try
            {
                var createGameRequest = new CreateGameRequest
                {
                    ...
                    GameId = GenerateRandomizedRoomName(MethodBase.GetCurrentMethod().Name)
                };
...
//                masterClient2 = this.CreateMasterClientAndAuthenticate(Player3);
        ...
        public void JoinCreateIfNotExistsLobbyProps()
        {
            ...
            try
            {
                ...
                joinRequest.Parameters[ParameterCode.RoomName] = roomName;
                joinRequest.Parameters[ParameterCode.JoinMode] = JoinModes.CreateIfNotExists;
        ...
        public void JoinWithSameNameCheckUserOnJoinFalse()
        {
            ...
            {
                client1 = this.CreateMasterClientAndAuthenticate(Player1);
                client2 = this.CreateMasterClientAndAuthenticate(Player1);
        ...
        // Joining game with deffered response tests
        [Test]
        public void JGDR_JoinNonCreatedOnGSGame()
        {
            ...
            try
            {
                ...
                Assert.IsFalse(client2.TryWaitForOperationResponse(1000, out resp));
        ...
        public void JoinMultipleGamesWithSameUserIdAndDifferentSessionsId()
        {
            ...
            try
            {
                ...
                {
                    var client = this.CreateMasterClientAndAuthenticate(Player1);
        ...
        public void JGDR_JoinNonCreatedOnGSGameFailedToCreate()
        {
            ...
            try
            {
                ...
                OperationResponse resp;
                Assert.IsTrue(client2.TryWaitForOperationResponse(25_000, out resp));
        ...
        public void JGDR_JoinNonCreatedOnGSGameWithExpectedUsers()
        {
            ...
            try
            {
                ...
                // same error afer actuall game creation
                client2.JoinGame(joinRequest, ErrorCode.GameFull);
            }
            finally
            {
        ...
        public void ApplicationStats()
        {
            ...
            try
            {
                ...
                Thread.Sleep(3500);
                var authParam = new Dictionary<byte, object>
                {
                };
                System.Console.WriteLine("-----------creating of client 1------------------------");
                // create clients
                client1 = this.CreateMasterClientAndAuthenticate(Player1, authParam);
                System.Console.WriteLine("-----------creating of client 2------------------------");
                client2 = this.CreateMasterClientAndAuthenticate(Player2, authParam);
                System.Console.WriteLine("-----------creating of client 3------------------------");
                client3 = this.CreateMasterClientAndAuthenticate(Player3, authParam);
                ...
                // we check here that peerCount == 0, although we do not do explicit diconnect for client1 and client2
        ...
        public void FindFriends()
        {
            ...
            try
            {
                ...
                client1.FindFriends(userIds, out onlineStates, out userStates);
                Assert.AreEqual(true, onlineStates[0]);
                Assert.AreEqual(false, onlineStates[1], $"{userIds[1]} disconencted from Master, but not shown as offline");
        ...
        public void FindFriendsAfterFailureToJoin()
        {
            ...
            try
            {
                ...
                client2.JoinGame(roomName, ErrorCode.GameFull);
        ...
        public void RaiseEventTargetActorsListTooooBig()
        {
            ...
            try
            {
                ...
                var raiseEventOp = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.ActorList, new int[]{1, 2, 3, 4, 5, 6}},
                ...
                raiseEventOp = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.ActorList, new int[]{3, 2, 2}},
                        {ParameterCode.Data, new Hashtable()}
                    }
                };
                ...
                EventData ev;
                Assert.IsTrue(client2.TryWaitForEvent(this.WaitTimeout, out ev));
                Assert.IsFalse(client2.TryWaitForEvent(this.WaitTimeout, out ev));
                ...
                Assert.IsTrue(client1.TryWaitForEvent(this.WaitTimeout, out ev));
                Assert.IsFalse(client2.TryWaitForEvent(this.WaitTimeout, out ev));
        ...
        public void RaiseEventTargetPrioritiesTest()
        {
            ...
            try
            {
                ...
                client2.SendRequest(new OperationRequest
                {
                    OperationCode = (byte)OperationCode.ChangeGroups,
                    Parameters = new Dictionary<byte, object>
                    {
                ...
                {
                    OperationCode = (byte)OperationCode.RaiseEvent,
                    Parameters = new Dictionary<byte, object>
                    {
                        {(byte)ParameterKey.Actors, new int[] {2, 3} },
                        { (byte)ParameterKey.Group, (byte)1},
                        {(byte)ParameterKey.ReceiverGroup, (byte)Photon.Realtime.ReceiverGroup.MasterClient },
                        {(byte)ParameterKey.Code, (byte)2 },
                    }
                });

                EventData ed;
                Assert.That(client2.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True);
                Assert.That(client3.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True);
                Assert.That(client1.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
                ...
                Assert.That(client2.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True);
                Assert.That(client3.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
                Assert.That(client1.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
                ...
                Assert.That(client1.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True);
                Assert.That(client2.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
                Assert.That(client3.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
            }
            finally
            {
        ...
        public void GameStateTest()
        {
            ...
            try
            {
                ...
                var expectedUsers = new string[] {"P1", "P2", "P3"};
                ...
                var createGameProperties = new Hashtable
                {
                    ...
                    {(byte)GameParameter.LobbyProperties, new string[] { "lobby3Key", "lobby4Key" } },
                    {"prop1Key", "prop1Val"},
                    {"prop2Key", "prop2Val"},
                    {"lobby3Key", "lobby3Val"},
                    {"lobby4Key", "lobby4Val"},
                ...
                var createGameRequet = new CreateGameRequest
                {
                    PlayerTTL = int.MaxValue,
                ...
                masterClient.CreateGame(createGameRequet);
                Thread.Sleep(300);// wait while game is created on gameserver
        ...
        public void Http_HttpResponseHeaders()
        {
            ...
            try
            {
                var createGameRequest = new CreateGameRequest()
                {
                    GameId = GenerateRandomizedRoomName(pluginName),
                ...
                var responseGS = client.CreateGame(createGameRequest);
        ...
        public void Http_HttpMethodsTest(string mode)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < methods.Length; ++i)
                {
                    ...
                    Assert.That(client.TryWaitEvent(123, this.WaitTimeout, out eventData), 
                        "Failed to get response for method {0}", methods[i]);

                    Dictionary<byte, object> result = eventData.Parameters;
        ...
        public void LeaveEventTest()
        {
            ...
            try
            {
                ...
                var actorsList = (int[])ev[(byte) ParameterCode.ActorList];
                ...
                actorsList = (int[])ev[(byte)ParameterCode.ActorList];
                Assert.That(actorsList, Is.Not.Null);
                Assert.That(actorsList.Length, Is.EqualTo(1));
                Assert.That(actorsList[0], Is.EqualTo(1));
                Assert.That(ev[ParameterCode.ActorNr], Is.EqualTo(2));
        ...
        public void ReceiveLobbyStatSettingTest()
        {
            ...
            try
            {
                client1 = this.CreateMasterClientAndAuthenticate(Player1);
                EventData ev;
                Assert.IsFalse(client1.TryWaitForEvent(EventCode.LobbyStats, 3000, out ev));
                ...
                Assert.IsTrue(client1.TryWaitForEvent(EventCode.LobbyStats, 3000, out ev));
            }
            finally
            {
                DisposeClients(client1);
        ...
        public void RejoinOrJoinFailsIfGameNotExistTest()
        {
            ...
            try
            {
                ...
                masterClient1.JoinGame(joinRequest, (short)ErrorCode.GameDoesNotExist);
            }
            finally
            {
                DisposeClients(masterClient1);
        ...
        public void DisconnectAfterTooManyConcurrentJoinRequestsTest(byte operation)
        {
            ...
            try
            {
                ...
                Thread.Sleep(3500);// 3000 ms is current disconnect time;
        ...
        public void DisconnectAfterTooManyTotalJoinRequestsTest(byte operation)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 10; ++i)
                {
                    ...
                    if (!client1.TryWaitForOperationResponse(this.WaitTimeout, out response))
                    {
                        break;
                    }
                }
        ...
        public void DisconnectAfterTooManyConcurrentJoinRandomRequestsTest()
        {
            ...
            try
            {
                ...
                var cgResp = client2.CreateGame(GenerateRandomizedRoomName(MethodBase.GetCurrentMethod().Name));
        ...
        public void LimitCreateGameRequestsTest()
        {
            ...
            try
            {
                ...
                client2.CreateGame(request, ErrorCode.Ok);
            }
            finally
            {
                DisposeClients(client1, client2);
        ...
        public void EmptyRoomBug()
        {
            ...
            try
            {
                ...
                var r = new OperationRequest
                {
                    ...
                    Parameters = new Dictionary<byte, object>
                    {
                        {ParameterCode.IsInactive, new string[]{"xxx"}},
                        {ParameterCode.EventForward, new string[]{"xxx"}}
                    }
                };
        ...
        public void WrongGameRemovalOnMasterTest()
        {
            ...
            if (this.connectPolicy.IsOnline && !this.connectPolicy.IsRemote)
            {
                Assert.Ignore("Test does not work for local online tests");
            }
            ...
            try
            {
                ...
                Thread.Sleep(joinRequest.PlayerTTL + 50);
                ...
                // client 1: connects to GS and trys to join not existing game on the game server 
                this.ConnectAndAuthenticate(masterClient1, joinResponse1.Address, masterClient1.UserId);
        ...
        public void GlobalBanPlayerTest()
        {
            ...
            try
            {
                ...
                Thread.Sleep(300);
                client2 = this.CreateMasterClientAndAuthenticate(banUserId);
                ...
                client2.Authenticate(client2.UserId, new Dictionary<byte, object>{{ParameterCode.Secret, client2.Token}}, (short) Photon.Common.ErrorCode.UserBlocked);
            }
            finally
            {
                DisposeClients(client1, client2);
        ...
        public void WebRpcCall()
        {
            ...
            try
            {
                ...
                client1.SendRequestAndWaitForResponse(webRpcRequest, 0);
            }
            finally
            {
                DisposeClients(client1);
        ...
        public void Groups_AddManyTimesToSameGroup()
        {
            ...
            try
            {
                ...
                EventData ed;
                Assert.That(masterClient1.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True);
                Assert.That(masterClient1.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
            }
            finally
            {
                DisposeClients(masterClient1);
        ...
        public void Groups_AddRemoveToFromAllGroups()
        {
            ...
            try
            {
                ...
                for (byte i = 1; i < 4; i++)
                {
                    ...
                    EventData ed;
                    Assert.That(masterClient2.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.True, "Failed on iteration {0}", i);
                }
                ...
                for (byte i = 1; i < 4; i++)
                {
                    ...
                    EventData ed;
                    Assert.That(masterClient2.TryWaitForEvent((byte)2, this.WaitTimeout, out ed), Is.False);
                }
            }
            finally
            {
        ...
        {
            Console.WriteLine("---Begin of Game list check---");
        ...
        {
            return (string.IsNullOrEmpty(this.GameNamePrefix) ? string.Empty : this.GameNamePrefix + "_") + GenerateRandomString(roomName);
        }
        ...
        static private bool RepetitiveCheck(Func<bool, bool> checkFunc, int times)
        {
            var i = 0;
