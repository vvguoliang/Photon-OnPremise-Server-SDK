...
namespace Photon.LoadBalancing.UnitTests.UnifiedTests
{
    public abstract partial class LBApiTestsImpl
    {
        ...
        /// </summary>
        [Test]
        public void GetGameUpdate_LobbyPropertyChange([Values(LobbyType.Default, LobbyType.SqlLobby)]LobbyType lobbyType)
        {
            UnifiedTestClient client1 = null;
            UnifiedTestClient client2 = null;
        ...
        [Test]
        public void GetGameUpdate_ExpectedUsersPropertyChange([Values(LobbyType.Default,LobbyType.SqlLobby)]LobbyType lobbyType)
        {
            UnifiedTestClient client1 = null;
            UnifiedTestClient client2 = null;
