...
namespace Photon.Common.Authentication.Configuration.Auth
{
    public class AuthProvider : ConfigurationElement
    {
        ...
        [ConfigurationProperty("ForwardAsJSON", DefaultValue = "false", IsRequired = false)]
        public bool ForwardAsJSON
        {
            get
            {
                return (bool)base["ForwardAsJSON"];
            }

            set
            {
                base["ForwardAsJSON"] = value;
            }
        }
