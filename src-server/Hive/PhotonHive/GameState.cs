...
namespace Photon.Hive
{
    ...
    public class GameState 
    {
        ...
        public int PlayerTTL {
            ...
            set
            {
                this.Properties.Set((byte)GameParameter.PlayerTTL, value);
            }
        }
        ...
        public int EmptyRoomLiveTime {
            ...
            set
            {
                this.Properties.Set((byte)GameParameter.EmptyRoomTTL, value);
            }
        }
        ...
        {
            get { return this.GetRoomFlag(RoomOptionFlags.BroadcastPropsChangeToAll); }
