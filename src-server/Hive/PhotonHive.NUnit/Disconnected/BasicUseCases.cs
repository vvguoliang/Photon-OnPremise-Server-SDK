    ...
    public class BasicUseCases
    {
        ...
        public void JoinGameOldRejoin()
        {
            ...
            try
            {
                ...
                request[(byte)ParameterKey.JoinMode] = JoinModes.RejoinOnly;
                PeerHelper.InvokeOnOperationRequest(litePeerTwo, request, new SendParameters());
                Assert.IsTrue(peerTwo.WaitForNextResponse(WaitTimeout));
        ...
        public void GetSetGameState()
        {
            ...
            try
            {
                ...
                request.Parameters[(byte)ParameterKey.JoinMode] = JoinModes.RejoinOnly;
                PeerHelper.InvokeOnOperationRequest(litePeerTwo, request, new SendParameters());
                Assert.IsTrue(peerTwo.WaitForNextResponse(WaitTimeout));
        ...
        public void GetSetNewGameState()
        {
            ...
            try
            {
                ...
                game.EventCache.AddEvent(0, new CustomEvent(1, 4, new string[] { "4" }), out msg);
        ...
        public void EventCacheGetUserResponse()
        {
            ...
            try
            {
                ...
                // checke that we can not join and get correct error code and debug message
                PeerHelper.InvokeOnOperationRequest(litePeerTwo, request, new SendParameters());
                Assert.IsTrue(peerTwo.WaitForNextResponse(WaitTimeout));
                resp = peerTwo.GetResponseList();
        ...
        public void JoinCheckUserIds()
        {
            ...
            try
            {
                ...
                request = GetJoinRequest();
                request.Parameters[(byte) ParameterKey.JoinMode] = (byte) JoinModes.RejoinOnly;
                request.Parameters[(byte)ParameterKey.ActorNr] = actorNr;
        ...
        public void JoinDisconnectRejoinWithGroups()
        {
            ...
            try
            {
                ...
                parameter[(byte)ParameterKey.JoinMode] = JoinModes.RejoinOnly;
...
//            Thread.Sleep(1100);
        ...
        public void HandleWebRpcOpTest()
        {
            ...
            var mngr = new WebRpcManager(env);
            if (mngr.IsRpcEnabled)
            {
                litePeerOne.WebRpcHandler = mngr.GetWebRpcHandler();
            }
        ...
        protected static OperationRequest GetJoinRequest(Dictionary<byte, object> customParameter)
        {
            ...
            {
                customParameter.Add((byte) ParameterKey.JoinMode, JoinModes.CreateIfNotExists);
            }
