...
namespace Photon.UnitTest.Utils.Basic.NUnitClients
{
    ...
    public class OnlineNUnitClient : INUnitClient, IPhotonPeerListener
    {
        ...
        public EventData WaitForEvent(int millisecodsWaitTime)
        {
            ...
            return this.EventQueue.Dequeue(millisecodsWaitTime);
        }

        public EventData WaitEvent(byte eventCode, int millisecodsWaitTime = ConnectPolicy.WaitTime)
        {
            return this.EventQueue.DequeueIf(data => { return data.Code == eventCode;}, millisecodsWaitTime);
        }
        ...
        {
            return this.OperationResponseQueue.Dequeue(millisecodsWaitTime);
        }
        ...
        {
            this.Peer.SendMessage(message, true,0,false);
        }
        ...
        public void InitEncryption()
        {
            ...
            //this.autoResetEventInit.WaitOne(3000);
        }
        ...
        public void SetupEncryption(Dictionary<byte, object> encryptionData)
        {
            ...
            this.Peer.InitDatagramEncryption(secret, hmacSecret, 
                mode == EncryptionModes.DatagramEncyptionWithRandomInitialNumbers, 
                mode == EncryptionModes.DatagramEncyptionGCMWithRandomInitialNumbers);
        }
