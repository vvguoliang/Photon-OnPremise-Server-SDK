...
//    {
//        private static Mutex mut = new Mutex(false, "NameServer.LoadTest.Client");
//        private static bool boss;
//        private static bool useDummyCounters;

//        const string connectedClients = "Connected Clients";
//        const string responsesPerSec = "Responses / sec";
//        const string roundtripTime = "RoundTrip Time";

//        const string successfulResponsesPerSec = "Successful responses / sec";
//        const string rejectedRequestsPerSec = "Rejected requests / sec";

//        const string totalRequestsSent = "Total Requests";
//        const string totalSuccessfulResponses = "Total successful";
...
//        public static readonly string CategoryName = "Photon: NameServer LoadTest";
...
//                                new CounterCreationData(totalSuccessfulResponses, string.Empty, PerformanceCounterType.AverageCount64),
...
//                                new CounterCreationData(totalRequestsSent, string.Empty, PerformanceCounterType.RateOfCountsPerSecond64),
//                                new CounterCreationData(successfulResponsesPerSec, string.Empty, PerformanceCounterType.RateOfCountsPerSecond64),
//                                new CounterCreationData(rejectedRequestsPerSec, string.Empty, PerformanceCounterType.AverageCount64),
//                                new CounterCreationData(reliableEventRoundtripTimeBase, string.Empty, PerformanceCounterType.AverageBase),
//                                new CounterCreationData(responsesPerSec, string.Empty, PerformanceCounterType.RateOfCountsPerSecond64),
...
//            FlushEventRoundTripTime = new WindowsPerformanceCounter(GetPerformanceCounter(totalSuccessfulResponses, "_Total", false));
...
//            FlushOperationsSent = new WindowsPerformanceCounter(GetPerformanceCounter(totalRequestsSent, "_Total", false));
//            //                    new WindowsPerformanceCounter(
//            //                        new PerformanceCounter(CategoryName, flushoperationsSentSec, AppDomain.CurrentDomain.FriendlyName, false));
//            ReceivedOperationResponse = new WindowsPerformanceCounter(GetPerformanceCounter(successfulResponsesPerSec, "_Total", false));
//            //                    new WindowsPerformanceCounter(
//            //                        new PerformanceCounter(CategoryName, receivedOperationResponsesSec, AppDomain.CurrentDomain.FriendlyName, false));
//            ReliableEventsReceived = new WindowsPerformanceCounter(GetPerformanceCounter(responsesPerSec, "_Total", false));
//            //                    new WindowsPerformanceCounter(
//            //                        new PerformanceCounter(CategoryName, reliableEventsReceivedSec, AppDomain.CurrentDomain.FriendlyName, false));
//            ReliableEventRoundTripTime = new WindowsPerformanceCounter(GetPerformanceCounter(rejectedRequestsPerSec, "_Total", false));
//            //                    new WindowsPerformanceCounter(
...
//            FlushEventRoundTripTime = new DummyCounter(totalSuccessfulResponses);
...
//            ReceivedOperationResponse = new DummyCounter(successfulResponsesPerSec);
//            ReliableEventsReceived = new DummyCounter(responsesPerSec);
//            ReliableEventRoundTripTime = new DummyCounter(rejectedRequestsPerSec);
